package truequek.repository;

import truequek.TruequekApp;
import truequek.config.Constants;
import truequek.config.audit.AuditEventConverter;
import truequek.domain.PersistentAuditEvent;
...
import static truequek.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
